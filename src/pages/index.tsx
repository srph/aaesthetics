        ...
        <div className="flex flex-wrap">
          {services.map(service => (
            <div className="flex-shrink-0 w-1/2 px-4 mb-6 text-center">
              ...
              <h4 className="mb-4 font-sm h-12 font-heading uppercase text-gold-500 mx-auto">
                {service.name}
              </h4>

              <p className="mb-8 font-body font-medium leading-loose">
                {service.description}
              </p>
            </div>
          ))}
      ...
      <Section>
        ...
        <div className="relative mb-36 px-12 pt-12 bg-gold-500">
          <p className="text-white font-body text-2xl leading-normal text-center mx-auto w-3/5">
            Dr. Claudine Roura offers a wide range of cosmetic upgrade options,
            whether it is surgical or non-surgical, you'll be pleased with the
            results. Learn more about all of our service offerings by clicking
            the button below.
          </p>
        ...
        <div className="max-w-4xl mx-auto">
          <Accordion>
            <AccordionItem label="What is vaserlipo?">
              <AccordionParagraph>
                Dr. Claudine Roura offers a wide range of cosmetic upgrade
                options, whether it is surgical or non-surgical, you'll be
                pleased with the results. Learn more about all of our service
                offerings by clicking the button below.
              </AccordionParagraph>
            </AccordionItem>
